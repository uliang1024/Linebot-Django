...
# 添加定时任务，并设置触发时间（台湾时间）
scheduler.add_job(settlement_event, 'cron', hour=11, minute=53, timezone=taipei_tz)
scheduler.add_job(reminder_event, 'cron', hour=11, minute=54, timezone=taipei_tz)
scheduler.add_job(report_event, 'cron', hour=11, minute=55, timezone=taipei_tz)
